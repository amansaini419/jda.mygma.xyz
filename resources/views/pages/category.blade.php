                ...
                <div class="card-footer bg-transparent">
                    @if($votingStatus === 'voting active')
                        ...
                        @else
                            ...
                            @else
                                @if ($selectedCandidate && $selectedCandidate->nominee_id === $nominee->id)
                                    <h4 class="text-uppercase fw-medium fs-6">selected</h4>
                                @else
            ...
            {{-- @if($category->nominees->count() == 1)
                <div class="card text-center rounded-3 shadow border-0 m-3 h-100" style="width: 320px;">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <h3 class="card-title fw-bold mb-2 fs-5 text-uppercase">NO VOTE</h3>
                        <blockquote class="blockquote">
